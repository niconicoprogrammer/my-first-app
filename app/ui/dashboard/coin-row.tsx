    ...
    >
      ...
      <td className="py-3 px-4 w-[180px]">
        <div className="flex gap-2">
          <button className="px-3 py-1 bg-blue-500 hover:bg-blue-400 rounded text-white text-xs">
            買う
          </button>
          <button className="px-3 py-1 bg-red-500 hover:bg-red-400 rounded text-white text-xs">
            売る
          </button>
        </div>
      </td>
